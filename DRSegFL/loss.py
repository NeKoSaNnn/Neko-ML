...
class CrossEntropyLoss(nn.Module):
    ...
    def __init__(self, use_sigmoid=False, reduction="mean", class_weight=None, loss_weight=1.0):
    ...
    @classmethod
    def cross_entropy(cls, pred, label, weight=None, class_weight=None, reduction="mean", avg_factor=None, ignore_index=-100):
