...
class args(neko_args.neko_args):
    def __init__(self):
        ...
        # federated arguments
        self.parser.add_argument("--iid", action="store_true", help="whether i.i.d or not")
        self.parser.add_argument("--num_users", type=int, default=100, help="number of users: K")
        self.parser.add_argument("--frac", type=float, default=0.1, help="the fraction of clients: C")
